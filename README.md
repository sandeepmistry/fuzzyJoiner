...
`python3 build_model.py --input names_to_cleanse/peoplesNames.txt --loss_function our-loss --use_l2_norm False --num_layers 3 --entity_type people --model /tmp/model --data /tmp/data`
